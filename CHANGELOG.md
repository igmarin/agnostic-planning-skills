...
- `.opencode/agents/` wrappers for opencode subagent support (5 persona wrappers with tool restrictions).
...
- All 10 atomic skills now have `type: atomic` in frontmatter.
