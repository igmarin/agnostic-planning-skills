...
metadata:
  ...
  constraints: "NO CODE — produces requirements only. Never implementation. Creating planning deliverables (documents, specifications) is permitted; editing project source/config/test files is prohibited."
---
